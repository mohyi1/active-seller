      ...
      duration: Duration(seconds: 1),
        ...
        curve: Curves.fastOutSlowIn,
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("منتج تالف",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold,color: MyTheme.app_accent_color),),
                      SizedBox(height: 5,),
                      Row(
                        children: [
                          Image.asset('assets/icon/calender.png',width: 12,height: 12,),
                          SizedBox(width: 8,),
                          Text("منتج تالف",style: TextStyle(fontSize: 12,fontWeight: FontWeight.normal,color: MyTheme.font_grey),),
                        ],
                      ),
                      SizedBox(height: 5,),
                      Row(
