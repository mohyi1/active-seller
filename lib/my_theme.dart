...
class MyTheme {
  static const Color app_accent_color = Color.fromRGBO(206, 220, 39, 1);
  static Color app_accent_color_extra_light =
      Color.fromRGBO(233, 233, 240, 1.0);

  static Color splash_screen_color = Color.fromRGBO(0, 0, 0, 1); // if not sure , use the same color as accent color
  static Color login_reg_screen_color = Color.fromRGBO(255, 255, 255, 1); // if not sure , use the same color as accent color

  /*configurable colors ends*/

  /*If you are not a developer, do not change the bottom colors*/
  static const Color app_accent_border = Color.fromRGBO(0, 0, 0, 1);
